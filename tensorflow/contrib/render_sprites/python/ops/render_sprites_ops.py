...
from tensorflow.contrib.render_sprites.ops import gen_render_sprites_ops
from tensorflow.contrib.util import loader
from tensorflow.python.framework import ops
from tensorflow.python.platform import resource_loader

_render_sprites_so = loader.load_op_library(
    resource_loader.get_path_to_datafile("_render_sprites_ops.so"))
...
def render_sprites(sprites, n_sprites, scales, offsets, backgrounds, name="render_sprites"):
  ...
  with ops.name_scope(name, "render_sprites", [sprites, n_sprites, scales, offsets, backgrounds]):
    ...
    return gen_render_sprites_ops.render_sprites(
...
def _render_sprites_grad(op, grad_output):
  ...
  return gen_render_sprites_ops.render_sprites_grad(
